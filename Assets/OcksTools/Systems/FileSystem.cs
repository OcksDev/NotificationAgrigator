...
public class FileSystem : MonoBehaviour
{
    ...
    public const string GameVer = "v1.0";
    private const string GameFolderName = "NotifManager";
    private const string GameTrueName = "Notification Agrigator";
    ...
    private void Awake()
    {
        ...
        CreateFolder($"{GameDirectory}\\Notifs");
        CreateFolder($"{GameDirectory}\\Retired");
